...
elseif theme == "Neon" then
    ...
    theme2 = Color3.fromRGB(30,30,30)
    theme3 = Color3.fromRGB(0, 255, 170) -- bright neon green-blue
    print("Theme selected: "..theme)

elseif theme == "Sunset" then
    theme1 = Color3.fromRGB(35, 24, 36)
    theme2 = Color3.fromRGB(28, 19, 30)
    theme3 = Color3.fromRGB(255, 94, 98) -- sunset pink/red
    print("Theme selected: "..theme)

elseif theme == "Ice" then
    theme1 = Color3.fromRGB(25, 30, 40)
    theme2 = Color3.fromRGB(20, 25, 35)
    theme3 = Color3.fromRGB(120, 220, 255) -- icy blue
    print("Theme selected: "..theme)

elseif theme == "Gold" then
    theme1 = Color3.fromRGB(32,32,32)
    theme2 = Color3.fromRGB(26,26,26)
    theme3 = Color3.fromRGB(255, 215, 0) -- shiny gold
    print("Theme selected: "..theme)

elseif theme == "Candy" then
    theme1 = Color3.fromRGB(40, 20, 40)
    theme2 = Color3.fromRGB(30, 10, 30)
    theme3 = Color3.fromRGB(255, 105, 180) -- hot pink
    print("Theme selected: "..theme)

elseif theme == "Ocean" then
    theme1 = Color3.fromRGB(22, 28, 38)
    theme2 = Color3.fromRGB(18, 24, 32)
    theme3 = Color3.fromRGB(0, 140, 255) -- deep blue
    print("Theme selected: "..theme)

elseif theme == "Lime" then
    theme1 = Color3.fromRGB(32,32,32)
    theme2 = Color3.fromRGB(26,26,26)
    theme3 = Color3.fromRGB(173, 255, 47) -- lime green
    print("Theme selected: "..theme)

elseif theme == "Royal" then
    theme1 = Color3.fromRGB(28, 28, 40)
    theme2 = Color3.fromRGB(22, 22, 32)
    theme3 = Color3.fromRGB(120, 81, 169) -- royal purple
    print("Theme selected: "..theme)
...
shadow.Image = "rbxassetid://1316045217" -- soft round shadow image
...
Toggle_2.Font = Enum.Font.GothamBold
Toggle_2.Text = text
...
function InsideTab:CreateCheckbox(text,callback)
    ...
    Cheat.Text = text
    Cheat.Font = Enum.Font.GothamBold
